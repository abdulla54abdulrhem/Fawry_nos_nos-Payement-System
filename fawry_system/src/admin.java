...
public class admin extends UserAbstract implements ObserverAdmin {
    ...
    void addGenaralDiscount(int dis){
        adminController.addGenaralDiscount(dis);
    }
    void addSpecificDiscount(int dis,int servicOption){
        adminController.addSpecificDiscount(dis,servicOption);
    }
    ArrayList<RefundRequest> showAllRefunds(){
        return this.refundRequests;
    }
    boolean manageRequest(int id,boolean acceptRefund){
